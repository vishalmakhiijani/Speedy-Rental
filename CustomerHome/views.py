...
def CheckAvailability(request,Vehicle_license_plate):
    ...
    for rv in rentvehicle:
        ...
        # if (RentVehicle_Date_of_Booking < rv.RentVehicle_Date_of_Booking and RentVehicle_Date_of_Return <h1 rv.RentVehicle_Date_of_Booking) or (RentVehicle_Date_of_Booking > rv.RentVehicle_Date_of_Return and RentVehicle_Date_of_Return > rv.RentVehicle_Date_of_Return):
        #     Available = True
...
def contact_us(request):
    if request.method=="POST": # post method
      ...
      # get all fields in variables from contactus form
      name=request.POST.get('name')
      email=request.POST.get('email')
      subject=request.POST.get('subject')
      message=request.POST.get('message')
      # save the all above fields
      contact.name=name
      contact.email=email
